...
export default function AlbumView() {
  ...
  const handleUploadClick = () => {
    ...
    // See the matching fix in Dashboard.tsx: Android Chrome/WebView often
    // won't reliably open the picker or fire onchange on a detached input.
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container max-w-7xl mx-auto p-4 md:p-6 lg:p-8 pb-32 lg:pb-8">
      ...
      <BottomNav currentPath={`/album/${albumId}`} onUploadClick={handleUploadClick} />
    </div>
  );
}
